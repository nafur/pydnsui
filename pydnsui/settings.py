"""
Django settings for pydnsui project.
...
SECRET_KEY = '(v5@i1l*$((is9(szz_ok5j*q3ilor-+lwb7%$!z=00b@+6)2('
...
TEMPLATES = [
	{
		...
		'OPTIONS': {
			...
			'libraries': {
				'helpers': 'pydnsui.templatetags.helpers',
			},
			'loaders': [
...
WSGI_APPLICATION = 'pydnsui.wsgi.application'
